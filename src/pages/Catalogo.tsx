...
const priceRanges = [
  { label: 'Todos', min: 0, max: 10000000 },
      ...
      {showFilters && (
        <div className="mb-8 rounded-2xl border border-border bg-card p-6">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              <h3 className="mb-3 text-sm font-medium text-muted-foreground">Talla</h3>
              <div className="flex flex-wrap gap-2">
                {tallas.map((talla) => (
                  <button
                    key={talla}
                    onClick={() =>
                      setSelectedSize(selectedSize === talla ? null : talla)
                    }
                    className={cn(
            ...
            <div>
              <h3 className="mb-3 text-sm font-medium text-muted-foreground">Precio</h3>
